    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          status:
            "A streaming platform clone where users can browse and view information about various movies and shows. It was developed to practice working with APIs and React frameworks, featuring a responsive interface and dynamic content fetching.",
          tech: "ReactVite, css, js, API",
          github: "https://github.com/rakha-elctrnx/muslim-companion",
          demo: "https://devflix-i2yzmbcqi-di0rio.vercel.app/",
        },
        {
          id: 3,
          name: "KEEVE",
          imageUrl: "sistekdes",
          status:
            "KEEVE is a web system transforming vehicle rental management. Built with React Vite and a C# backend, it offers an intuitive, responsive interface for quickly finding vehicles across multiple lots. Key features include custom filters, rental history, and low-availability alerts, ensuring a secure and efficient user experience.",
          tech: "ReactVite, Tailwind, C#, Asp Net Core, Figma",
          github: "https://github.com/di0rio/KEEVE",
          demo: "null",
        },
        {
          id: 4,
          ...
          imageUrl: "bumdesma",
          status:
            "This repository contains the source code for the web system of the Aquaguardians game, an interactive game that combats water pollution in Brazil. The system is developed using React Vite for the frontend interface and a C# .NET 8.0 API for the backend logic.",
          tech: "ReactVite, Bootstrap, Asp Net Core, C#",
          github:
...
<template>
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-purple-50 mx-3">
    <article data-page="about">
      <header>
        <div
          class="text-2xl font-bold text-white mb-10 fadein-bot title-section flex items-center justify-center flex-col"
        >
          <!-- <div class="h-[1px] w-10 bg-purple-200 md:w-20 aos-init aos-animate"></div> -->
          <h4>Past Project Experience</h4>
          <h4
            class="text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-purple-300"
          >
        ...
        <div>
          ...
          >
            <div v-for="item in items" :key="item.id">
              <div
                class="item-card flex flex-col items-center gap-2 rounded bg-[#1e1e1f] hover:bg-[#282828] border border-[#383838] rounded-xl text-purple-50 md:gap-3 px-5 py-5 lg:px-5"
              >
                <div
